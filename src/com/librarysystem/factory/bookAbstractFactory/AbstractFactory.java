...
public interface AbstractFactory {
    ...
    Book createPhysicalBook(int id, String title, String author, int pages, boolean available,String url);
    Book createEBook(int id, String title, String author, double sizeMB, boolean available,String url);
    Book createAudioBook(int id, String title, String author, double duration, boolean available,String url);
